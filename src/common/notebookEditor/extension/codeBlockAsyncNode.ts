...
export const CodeBlockAsyncNodeAttributeSpec = { ...AsyncNodeAttributeSpec,
  ...
  [AttributeType.CodeBlockReferences]: noNodeSpecAttributeDefaultValue<CodeBlockReference[]>(),

  /** The array of strings containing the hashes of the textContent of each corresponding CodeBlockReference*/
  [AttributeType.CodeBlockHashes]: noNodeSpecAttributeDefaultValue<CodeBlockHash[]>(),
};
...
// == Util ========================================================================
export const createDefaultCodeBlockAsyncNodeAttributes = (): CodeBlockAsyncNodeAttributes =>
({
