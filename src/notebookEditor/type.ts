...
import { Image } from './extension/image/Image';
...
export const editorDefinition = {
  ...
  extensions: [ Bold, DropCursor, Document, GapCursor, Heading, Highlight, History, Image, NodeViewRemoval, Paragraph, SetDefaultMarks, Style, Text, TextStyle, UniqueNodeId ],
