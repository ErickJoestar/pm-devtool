...
export const editorDefinition = {
  ...
  extensions: [ Bold, DropCursor, Document, GapCursor, Heading, Highlight, History, Link, NodeViewRemoval, Paragraph, SetDefaultMarks, Style, Text, TextStyle, UniqueNodeId ],
